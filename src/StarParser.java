...
public class StarParser extends Parser {
	...
	public static final int
		...
		RULE_statement = 5, RULE_return_statement = 6, RULE_while_statement = 7, 
		RULE_if_statement = 8, RULE_for_statement = 9, RULE_fun_statement = 10, 
		RULE_relexpr = 11, RULE_bexpression = 12, RULE_bterm = 13, RULE_bfactor = 14, 
		RULE_read_statement = 15, RULE_write_statement = 16, RULE_fwrite_statement = 17, 
		RULE_fread_statement = 18, RULE_block = 19, RULE_matrix = 20, RULE_array = 21, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"while_statement", "if_statement", "for_statement", "fun_statement", 
			"relexpr", "bexpression", "bterm", "bfactor", "read_statement", "write_statement", 
			"fwrite_statement", "fread_statement", "block", "matrix", "array", "assignment_statement", 
	...
	public final Fun_statementContext fun_statement() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_fun_statement);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	private BtermContext bterm(int _p) throws RecognitionException {
		...
		int _startState = 26;
		enterRecursionRule(_localctx, 26, RULE_bterm, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final BfactorContext bfactor() throws RecognitionException {
		...
		enterRule(_localctx, 28, RULE_bfactor);
		try {
			setState(268);
			_errHandler.sync(this);
	...
	public final Fwrite_statementContext fwrite_statement() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_fwrite_statement);
		int _la;
		try {
			setState(399);
			_errHandler.sync(this);
	...
	public final Fread_statementContext fread_statement() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_fread_statement);
		int _la;
		try {
			setState(418);
			_errHandler.sync(this);
